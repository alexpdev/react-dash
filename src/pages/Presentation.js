          ...
          <div className="d-flex align-items-center">
            <Navbar.Collapse id="navbar-default-primary">
              <Nav className="navbar-nav-hover align-items-lg-center">
                <Nav.Link as={HashLink} to="#features">Data</Nav.Link>
                <Nav.Link as={HashLink} to="#pages">Pages</Nav.Link>
                <Nav.Link as={HashLink} to="#" className="d-sm-none d-xl-inline">link2</Nav.Link>
                <Nav.Link as={HashLink} to="#">link3</Nav.Link>
                <Nav.Link as={HashLink} to="#download">download</Nav.Link>
              </Nav>
            </Navbar.Collapse>
        ...
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              ...
              <h1 className="fw-bolder text-secondary">My Dashboard</h1>
